...
PREDICT_QWEN_VL_PATH_LIST = ["PREDICT/QA_DATASET_INFERENCE_3B.jsonl",
                            "PREDICT/QA_DATASET_INFERENCE_7B.jsonl",
                            "PREDICT/QA_DATASET_INFERENCE_32B.jsonl"]
OUTPUT_CSV = "PREDICT/QA_DATASET_ANSWER_EVAL.csv"

def main():
    with open(OUTPUT_CSV, "w") as f:
        f.write("Model, BLEU, ROUGE1, ROUGE2, ROUGEL, ROUGELsum, BERTScore_F1\n")
    ...
    for PREDICT_QWEN_VL_PATH in PREDICT_QWEN_VL_PATH_LIST:
        ...
        with open(OUTPUT_CSV, "a") as f:
            ...
            f.write(f"{PREDICT_ID},{results['bleu']:.4f},{results['rouge1']:.4f},{results['rouge2']:.4f},{results['rougeL']:.4f},{results['rougeLsum']:.4f},{results['bertscore_f1']:.4f}\n")
