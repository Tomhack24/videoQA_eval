...
QA_DATASET_GEMINI_PATH = "GROUND_TRUTH/NO_DEP_QA_DATASET_GEMINI.jsonl"
PREDICT_QWEN_VL_PATH_LIST = ["NO_DEP_INFERENCE/NO_DEP_QA_DATASET_INFERENCE_3B.jsonl",
                            "NO_DEP_INFERENCE/NO_DEP_QA_DATASET_INFERENCE_7B.jsonl",
                            "NO_DEP_INFERENCE/NO_DEP_QA_DATASET_INFERENCE_32B.jsonl"]
OUTPUT_CSV = "ANSWER/NO_DEP_QA_DATASET_ANSWER_EVAL.csv"
...
def main():
    ...
    for PREDICT_QWEN_VL_PATH in PREDICT_QWEN_VL_PATH_LIST:
        ...
        with open(OUTPUT_CSV, "a") as f:
            PREDICT_ID = PREDICT_QWEN_VL_PATH.split("/")[1].replace("NO_DEP_QA_DATASET_INFERENCE_", "").replace(".jsonl", "")
